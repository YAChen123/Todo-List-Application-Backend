...
public class JwtUtils {
    ...
    private String createToken(Map<String, Object> claims, UserAccountModel userDetails) {
    ...
    public Boolean validateToken(String token, UserAccountModel userDetails) {
